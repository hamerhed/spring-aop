...
import pl.hamerhed.aspects.counter.ArgumentsModifierAspect;
import pl.hamerhed.domain.media.MediaPlayer;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations= {"classpath:pl/hamerhed/aspects/counter/counter_aspects_config.xml"})
